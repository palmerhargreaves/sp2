...
/**
 * RealTotalBudget form base class.
 *
 * @method RealTotalBudget getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseRealTotalBudgetForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('real_total_budget[%s]');
