 ...
 */
abstract class BaseActivityVideoRecordsStatisticsHeadersGroupsForm extends BaseFormDoctrine
{
    public function setup()
    {
        $this->setWidgets(array(
            ...
            'allow_user_to_add' => new sfWidgetFormInputCheckbox(),
        ));
        ...
        $this->setValidators(array(
            ...
            'allow_user_to_add' => new sfValidatorBoolean(array('required' => false)),
        ));

        $this->widgetSchema->setNameFormat('activity_video_records_statistics_headers_groups[%s]');
    ...
    {
        return 'ActivityVideoRecordsStatisticsHeadersGroups';
    }
