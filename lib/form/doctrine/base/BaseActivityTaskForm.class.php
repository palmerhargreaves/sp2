...
/**
 * ActivityTask form base class.
 *
 * @method ActivityTask getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseActivityTaskForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('activity_task[%s]');
