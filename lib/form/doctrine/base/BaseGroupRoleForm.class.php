...
/**
 * GroupRole form base class.
 *
 * @method GroupRole getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseGroupRoleForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('group_role[%s]');
