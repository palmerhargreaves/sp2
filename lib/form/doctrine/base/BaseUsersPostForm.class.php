...
/**
 * UsersPost form base class.
 *
 * @method UsersPost getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseUsersPostForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('users_post[%s]');
