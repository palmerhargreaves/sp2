...
/**
 * DealerWinterServiceAction form base class.
 *
 * @method DealerWinterServiceAction getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseDealerWinterServiceActionForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('dealer_winter_service_action[%s]');
  ...
  {
    return 'DealerWinterServiceAction';
  }
