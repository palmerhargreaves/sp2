...
/**
 * AgreementModelCategoriesFields form base class.
 *
 * @method AgreementModelCategoriesFields getObject() Returns the current form's model object
 *
 ...
 */
abstract class BaseAgreementModelCategoriesFieldsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'parent_category_id' => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('AgreementModelCategories'))),
    ...
    $this->widgetSchema->setNameFormat('agreement_model_categories_fields[%s]');
  ...
  {
    return 'AgreementModelCategoriesFields';
  }
