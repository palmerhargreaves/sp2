...
/**
 * Description of ValidatedFile
 *
 * @author Сергей
 */
class MaterialValidatedFile extends sfValidatedFile
{
    ...
    {
        $generator = new UniqueFileNameGenerator($this->getPath());
        return $generator->generate($this->getOriginalName());
    }
}
