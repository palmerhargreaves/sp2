 ...
 * @author Сергей
 */
class DealerAnswerDiscussionMail extends DiscussionMail
{
    function __construct(User $user, $entries = null, $email = '')
    {
...
TEXT;
        ...
        parent::__construct(
            ...
            array(
                'user' => $user,
                'subject' => 'Ответ на сообщение из раздела Контакты',
                'text' =>
<<<TEXT
