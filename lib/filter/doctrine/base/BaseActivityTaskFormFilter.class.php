...
/**
 * ActivityTask filter form base class.
 *
 ...
 */
abstract class BaseActivityTaskFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('activity_task_filters[%s]');
