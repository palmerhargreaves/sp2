...
/**
 * MaterialSource filter form base class.
 *
 ...
 */
abstract class BaseMaterialSourceFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('material_source_filters[%s]');
