...
/**
 * DiscussionLastRead filter form base class.
 *
 ...
 */
abstract class BaseDiscussionLastReadFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('discussion_last_read_filters[%s]');
