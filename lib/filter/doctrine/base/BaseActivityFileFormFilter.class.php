...
/**
 * ActivityFile filter form base class.
 *
 ...
 */
abstract class BaseActivityFileFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('activity_file_filters[%s]');
