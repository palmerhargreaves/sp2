...
/**
 * MaterialUserView filter form base class.
 *
 ...
 */
abstract class BaseMaterialUserViewFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('material_user_view_filters[%s]');
