...
Doctrine_Manager::getInstance()->bindComponent('WinterServiceAction', 'doctrine');

/**
 * BaseDealerWinterServiceAction
 * 
 ...
 */
abstract class BaseDealerWinterServiceAction extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('dealer_winter_service_action');
