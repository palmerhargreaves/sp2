...
class AgreementActivityStatusUtils
{
    ...
    public function updateActivityModelsNecessarilyTypes(User $user, $activity_id, $necessarily_type_id) {
        ActivityModelsTypesNecessarilyUsedTable::getInstance()->createQuery()
            ->delete()
            ->where('activity_id = ? and dealer_id = ? and necessarily_id = ?',
                array
                (
                    $activity_id,
