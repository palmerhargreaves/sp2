...
(function (root, factory) {
  ...
  function IntroJs(obj) {
    ...
    this._options = {
      nextLabel: 'Продолжить &rarr;',
      prevLabel: '&larr; Вернуться',
      skipLabel: 'Выход',
      doneLabel: 'Завершить',
  ...
  function _introForElement(targetElm) {
    ...
    if (this._options.steps) {
      ...
      var allIntroSteps = $('*').filter(function(){return $(this).data('intro') !== undefined;});;
      ...
      for (var i = 0, elmsLength = allIntroSteps.length; i < elmsLength; i++) {
        ...
        introItems.push({
          ...
          step: parseInt($(currentElement).data("step"), 10),
          position: $(currentElement).data("position") || this._options.tooltipPosition
        });
      }
    }
  ...
  function _showElement(targetElement) {
    ...
    if ($(targetElement.element).data("next-page")) {
        window.location = $(targetElement.element).data("next-page");
        return;
    }
    ...
    if(!$(targetElement.element).data("no-parent-fix"))
    ...
    if (!_elementInViewport(targetElement.element)) {
      ...
      if($(targetElement.element).data("no-scroll"))
        return;
      ...
      // Scroll down
          ...
          $('html,body').animate({scrollTop: bottom + 100}, 500);
