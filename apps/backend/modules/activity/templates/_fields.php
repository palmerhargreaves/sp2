<ul class="sf_admin_actions">
    <?php
    foreach ($activity->getActivityFieldList() as $item): ?>
        <li>
            <a href="<?php echo url_for('activity_fields/edit/?id=' . $item->getId()) ?>"><?php echo $item->getName() ?></a>
            <ul>
                <li class="sf_admin_action_delete">
                    <a href="<?php echo url_for('activity_fields/delete/?id=' . $item->getId()) ?>"
    ...
    <li class="sf_admin_action_new"><a
            href="<?php echo url_for('activity_fields/new?activity_id=' . $activity->getId()) ?>">Добавить</a></li>
</ul>
