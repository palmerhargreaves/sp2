...
<?php if (Utils::allowedIps()): ?>
    ...
    <div class="d-popup-cols">
        <div class="d-popup-col">
            ...
            <div class="d-popup-req-title number-field">
                ...
                <?php if (!$model->isConcept()): ?>
                    <strong style="width: 5%; position: relative; top: 7px;">№</strong>
        ...
        <div class="d-popup-col">
            ...
            <?php if (!$model->isValidModelCategory() || $model->getModelCategory()->getWorkType() == AgreementModelCategories::WORK_TYPE_MANAGER): ?>
            ...
            <div class="buttons">
                ...
                <?php if ($model->getNoModelChanges() && !$model->getNoModelChangesView()): ?>
                    <div class="check-as-viewed green button modal-form-button float-right" data-model-id="<?php echo $model->getId(); ?>" ><a href="javascript:;">Подтвердить</a></div>
                <?php endif; ?>
                ...
                <?php if (!$model->getIsBlocked() || $model->getAllowUseBlocked()): ?>
                    ...
                    <?php if ($model->getStatus() != 'accepted' && ($model->getStatus() != "wait_specialist" || $model->getStatus() == 'wait_manager_specialist')): ?>
