...
$default_messages_list = $data['unread_messages_list'];
    ...
    <div class="discussion__body">
        <div class="discussion__list">
            <div class="discussion__list__header">
                <span class="discussion__list__sort js-sort-dealers" data-sort-direction="desc"
                      data-sort-by="dealer_name">Дилер / Имя</span>
            ...
            <div class="discussion__list__search">
                <form action="">
                    <input type="text" id="txt_discussions_filter_by_name" name="txt_discussions_filter_by_name"
                           value=""/>
    ...
    <div class="discussion__header">
        <div class="discussion__header__body">
            ...
            <div data-container-type="all" class="discussion__header__tabs discussion-messages-list-by-type">
                <a href="javascript:" class="discussions-messages-status" data-type="all">Все</a>
                <a href="javascript:" class="current discussions-messages-status" data-type="unread">Непрочитанные</a>
            </div>
        </div>
    </div>
        ...
        <div class="discussion__comments">
            ...
            <div class="discussion__comments__footer">
                <form id="frm-discussion-model-messages" method="post" enctype="multipart/form-data" target="">
                    ...
                    <div id="frm-discussion-message" data-message-field="message" class="discussion__comments_text"
                         style="height: 60px;"></div>

                    <div class="discussion__comments__btns">
                        <input type="checkbox" id="js-send-message-to-importer" class="message-to-importer">
                        <label for="js-send-message-to-importer">Отправить импортеру</label><br/>
        ...
        <div class="discussion__comments" style="border-left: 0px; margin-left: 0px;">
            ...
            <div class="discussion__comments__footer">
                <form id="frm-discussion-ask" method="post" enctype="multipart/form-data" target="">
                    ...
                    <div id='frm-discussion-ask-message' data-message-field="ask" class="discussion__comments_text"
                         style="height: 60px;"></div>
                    <div class="discussion__comments__btns">
                        <input type="checkbox" id="js-send-message-ask-to-importer" class="message-to-importer">
                        <label for="js-send-message-ask-to-importer">Отправить импортеру</label><br/>
...
<script>
    $(function () {
        window.discussion_online.startAdmin({
            model_id: '<?php echo $data['default_model_id']; ?>',

            on_load_discussion_unread_url: '<?php echo url_for('@discussion_online_unread_count'); ?>',
            on_load_discussion_unread_models_url: '<?php echo url_for('@discussions_online_unread_models_count'); ?>',
