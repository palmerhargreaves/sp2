...
<div class="content-desc">Ниже перечислены сотрудники, зарегистрированные от Вашего дилерского предприятия. Пожалуйста,
    удалите тех, кто у Вас больше не работает или чей e-mail не актуален.
</div>
...
<div class="contributors-wrapper" id="dealer-users">
    <?php foreach ($users as $user): ?>
        <div class="contributor">
            ...
            <div class="position"><?php echo $user->getPostName() ?></div>
            <div class="email"><?php echo $user->getEmail() ?></div>
            <div class="remove"><a href="<?php echo url_for('dealer_user/delete?id=' . $user->getId()) ?>"
