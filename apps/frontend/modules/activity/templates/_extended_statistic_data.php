<?php
    $sections = ActivityExtendedStatisticSectionsTable::getInstance()->createQuery()->where('activity_id = ?', $activity->getId())
        ->orderBy($activity->getId() == 73 ? 'id ASC' : 'id DESC')
        ->execute();
                            ...
                            <?php } else if ($field->getValueType() == ActivityExtendedStatisticFields::FIELD_TYPE_FILE) { ?>
                                <div class="file">
                                    ...
                                    <div class="modal-file-wrapper input" style="width: 290px;">
                                        <div id="container_model_extended_statistic_files" class="control dropzone" style="min-height: 158px">
                                            ...
                                            <input type="file" name="field_file_<?php echo $fieldValue->getId(); ?>"
                                                    class='js-dealer-extended-statistics-upload-file field-<?php echo $fieldValue->getId(); ?>' size="1"
