...
<form action="<?php echo url_for("@agreement_module_models_report_update?activity={$activity->getId()}") ?>"
          class="form-horizontal" method="post" id="report-form" target="report-target">
    <?php else: ?>
    <form action="<?php echo url_for("@agreement_module_models_report_update?activity={$activity->getId()}") ?>"
          class="form-horizontal" method="post" id="report-form" target="report-target">
    <?php endif; ?>
                                ...
                                <div class="file">
                                    <div class="modal-file-wrapper input">
                                        <div id="container_model_files" class="control dropzone"
                                            ...
                                            <input type="file" name="additional_file" id="additional_file" multiple/>
                                        </div>
                                        <div class="modal-input-error-icon error-icon"></div>
                                        <div class="error message"></div>
                                    </div>
                                ...
                                <div class="file">
                                    <div class="modal-file-wrapper input">
                                        <div id="container_model_files" class="control dropzone"
                                            ...
                                            <input type="file" name="financial_docs_file" id="financial_docs_file"
                                                   multiple/>
                                        </div>
                                        <div class="modal-input-error-icon error-icon"></div>
                                        <div class="error message"></div>
