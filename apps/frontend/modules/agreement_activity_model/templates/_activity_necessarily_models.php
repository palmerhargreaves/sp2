...
<?php if (count($models) > 0 ): ?>
    <table class="models necessarily-models">
        <thead>
        <tr>
            <td width="80">
        ...
        <?php foreach ($models as $n => $model): ?>
            ...
            <tr class="sorted-row <?php echo $model->isValidModelCategory() ? 'model-row-with-category' : 'model-row'; ?><?php if (($n + count($blanks) % 2) % 2 == 0) echo ' even' ?><?php if ($model->getStatus() == 'not_sent') echo ' draft' ?> <?php echo $model->getId() == $modelId ? 'auto-click' : ''; ?> "
