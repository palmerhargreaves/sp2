    ...
    <div class="d-grid">
        ...
        <nav class="nav_quarts">
            <ul class="is-flexbox is-flexbox_justify">
                <li class="active">1 квартал</li>
                <li class="active">2 квартал</li>
                <li>3 квартал</li>
                <li>4 квартал</li>
            </ul>
        </nav>

        <h2 class="h1 d-ttu fw_400">Имиджевая кампания</h2>

        <h2 class="report-campaign-title is-flexbox">
            <span>168.</span>
            <span>Кампания по продвижению оригинальных аксессуаров</span>
        </h2>
            ...
            <div class="report-campaign-descr is-flexbox">
                ...
                <div class="report-campaign-descr__txt is-flexbox">
                    ...
                    <dl class="d-plain is-flexbox">
                        ...
                        <dd class="is-flexbox is-flexbox_center">Увеличение продаж оригинальных аксессуаров в период праздников: 14 февраля, 23 февраля, 8 марта.</dd>
                    </dl>
                    <dl class="d-plain is-flexbox">
                ...
                <div class="report-campaign-funnel__values">
                    <div class="report-campaign-funnel__values__chart">
                        <ul class="d-plain is-flexbox">
                            <li class="is-flexbox is-flexbox_center"><span>13</span></li>
                            <li class="is-flexbox is-flexbox_center"><span>10</span></li>
                            <li class="is-flexbox is-flexbox_center"><span>7</span></li>
                            <li class="is-flexbox is-flexbox_center"><span>2</span></li>
                        </ul>
                    </div>
                </div>
                <div class="report-campaign-funnel__legend">
                    <ul class="report-campaign-chart-legend d-plain">
                        <li class="is-blue">Все дилеры регионального менеджера</li>
