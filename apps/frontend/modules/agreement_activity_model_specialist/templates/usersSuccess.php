...
<?php if(count($users) > 0): ?>
  ...
  ?>
                      <tr class="sorted-row model-row<?php if($n % 2 == 0) echo ' even' ?>" >
                          ...
                          <td data-sort-value="<?php echo $dealer->getName(); ?>"><?php echo sprintf('%s', $dealer->getName()); ?></td>
                          ...
                          <td><div class="contributor" data-user-id='<?php echo $user->getId(); ?>' style="right: -23px; height: 30px;"><div class='remove' style='display: block;'></div></div>&nbsp;</td>
                      </tr>
  <?php endforeach; ?>
                  </tbody>
              </table>
