    ...
    <?php endif; ?>
            ...
            <div class="d-popup-cols">
                ...
                <div class="d-popup-col">
                    ...
                    <?php $show = false; ?>
                    <?php if ($show && $report->getStatus() != 'accepted' && $report->getStatus() != 'wait_specialist' && $report->getStatus() != 'declined'): ?>
                    ...
                    <div class="buttons">
                        ...
                        if (!$report->getModel()->getIsBlocked() || $report->getModel()->getAllowUseBlocked()): ?>
                            <?php if ($report->getStatus() != 'accepted' && $report->getStatus() != 'declined' || $report->getStatus() == 'declined'): ?>
