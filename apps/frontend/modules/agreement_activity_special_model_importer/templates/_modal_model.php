    ...
    $(function () {
        var controller = new AgreementModelManagementRootController({
            ...
            model_controller: new AgreementModelManagementController({
                ...
                load_url: '<?php echo url_for('@agreement_module_management_models_view_model_by_importer') ?>',
                decline_url: '<?php echo url_for('@agreement_module_management_models_decline_model_by_importer') ?>',
                accept_url: '<?php echo url_for('@agreement_module_management_models_accept_model_by_importer') ?>',
                accept_decline_url: '<?php echo url_for('@agreement_module_management_models_accept_model_by_importer') ?>',
                send_to_specialists_url: "<?php echo url_for('@agreement_module_management_models_send_model_to_specialists_by_importer') ?>",
            ...
            report_controller: new AgreementModelManagementController({
                ...
                load_url: '<?php echo url_for('@agreement_module_management_models_view_report_by_importer') ?>',
                decline_url: '<?php echo url_for('@agreement_module_management_models_decline_report_by_importer') ?>',
                accept_url: '<?php echo url_for('@agreement_module_management_models_accept_report_by_importer') ?>',
                accept_decline_url: '<?php echo url_for('@agreement_module_management_models_accept_report_by_importer') ?>',
                send_to_specialists_url: "<?php echo url_for('@agreement_module_management_models_send_report_to_specialists_by_importer') ?>",
                max_file_size: '<?php echo sfConfig::get('app_max_upload_size'); ?>',
                uploader_url: '<?php echo '/upload_ajax.php'; ?>',
                delete_temp_file_url: '<?php echo url_for('@upload_temp_ajax_delete'); ?>',
                panel_type: 'report'
